...
//        //模块地址
//        String modules = "/PdaApplication/";
//        //设置输出文件路径
//        gc.setOutputDir(projectPath +modules+"/src/main/java");
//        //作者
//        gc.setAuthor("AlanZhang");
...
//        dsc.setUrl("jdbc:mysql://47.108.251.176:3306/pda?serverTimezone=GMT%2B8&characterEncoding=utf8&useSSL=true");
...
//        //父包
//        pc.setParent("com.pda.api.domain");
//        //自定义实体包名(不同的模块自己手动修改)
//        pc.setEntity("entity");
...
//        //前后端分离时可开启
////        strategy.setRestControllerStyle(true); 表名
//        strategy.setInclude("order_excute_log");
