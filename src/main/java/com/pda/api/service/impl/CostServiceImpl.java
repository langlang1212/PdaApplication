...
import com.pda.api.service.CostService;
...
@Slf4j
@Service
public class CostServiceImpl extends PdaBaseService implements CostService {
    @Override
    public String fintCostInfo(Integer pageNum,String patientNo) {
        Date date = new Date();
        String param = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<root>\n" +
                "\t<AuthHeader>\n" +
                "\t\t<msgType>TJ603</msgType>\n" +
                "\t\t<msgId>F4A4F960-5B0E-4889-874B-DA732ECD0844</msgId>\n" +
                "\t\t<createTime>"+ PdaTimeUtil.getCreateTime(date) +"</createTime>\n" +
                ...
                "\t\t<EndCostTime>"+PdaTimeUtil.getLongTime(date)+"</EndCostTime>\n" +
                "\t\t<StarCostTime>"+PdaTimeUtil.getLongTime(date)+"</StarCostTime>\n" +
